...
package com.semanticcms.core.canonical.book;
 ...
 */
@WebServlet("/core/canonical/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/core/canonical/apidocs/com.semanticcms.core.canonical/com" + Objects.toString(req.getPathInfo(), ""),
